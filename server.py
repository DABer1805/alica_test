...
# https://disk.yandex.ru/i/P9D6qh2eyQK5WA - скрин с отправки на модерацию
...
cities = {
    'москва': ['1533899/a79d4d92612a91d16b42',
               '1533899/ad27c36f68d490851e0d'],
    'нью-йорк': ['1533899/2e172982299b9dbbd8ef',
                 '1533899/04f596ef19a898044446'],
...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if first_name is None:
            ...
            # как видно из предыдущего навыка, сюда мы попали, потому что
            # пользователь написал своем имя.
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'да' in req['request']['nlu']['tokens']:
                # если пользователь согласен, то проверяем не отгадал ли он
                # уже все города.
                ...
                if len(sessionStorage[user_id]['guessed_cities']) == 3:
                    ...
                    # функция, которая выбирает город для игры и
                    # показывает фото
                    play_game(res, req)
